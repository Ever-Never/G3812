...
.field private static final ACTIVE_SCALE:F = 1.61f
...
.field private final mActiveStroke:F
...
.field private mFramed:Lcom/android/internal/policy/impl/keyguard/KeyguardRectangleFramedDrawable;
...
.field private final mInactiveStroke:F
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    const v1, #android:color@keyguard_avatar_nick_color#t
    ...
    .line 120
    const v1, #android:dimen@keyguard_avatar_size#t
    ...
    .line 121
    const v1, #android:dimen@keyguard_avatar_frame_inactive_stroke_width#t

    invoke-virtual {v0, v1}, Landroid/content/res/Resources;->getDimension(I)F

    move-result v1

    iput v1, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardMultiUserAvatar;->mInactiveStroke:F

    .line 122
    const v1, #android:dimen@keyguard_avatar_frame_active_stroke_width#t

    invoke-virtual {v0, v1}, Landroid/content/res/Resources;->getDimension(I)F

    move-result v1

    iput v1, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardMultiUserAvatar;->mActiveStroke:F

    .line 123
    const v1, #android:dimen@keyguard_avatar_frame_shadow_radius#t
    ...
    .line 124
    const v1, #android:color@keyguard_avatar_frame_color#t
    ...
    .line 125
    const v1, #android:color@keyguard_avatar_frame_shadow_color#t
    ...
    .line 126
    const v1, #android:color@keyguard_avatar_frame_pressed_color#t
...
.method static synthetic access$000(Lcom/android/internal/policy/impl/keyguard/KeyguardMultiUserAvatar;)Lcom/android/internal/policy/impl/keyguard/KeyguardRectangleFramedDrawable;
    .locals 1
    .parameter "x0"

    .prologue
    .line 39
    iget-object v0, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardMultiUserAvatar;->mFramed:Lcom/android/internal/policy/impl/keyguard/KeyguardRectangleFramedDrawable;
...
.method public init(Landroid/content/pm/UserInfo;Lcom/android/internal/policy/impl/keyguard/KeyguardMultiUserSelectorView;)V
    ...
    .line 149
    const v0, #android:id@keyguard_user_avatar#t
    ...
    .line 150
    const v0, #android:id@keyguard_user_name#t
    ...
    const v2, #android:drawable@ic_contact_picture#t
    ...
    .line 165
    :cond_1
    new-instance v0, Lcom/android/internal/policy/impl/keyguard/KeyguardRectangleFramedDrawable;
    ...
    iget v4, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardMultiUserAvatar;->mInactiveStroke:F
    ...
    invoke-direct/range {v0 .. v7}, Lcom/android/internal/policy/impl/keyguard/KeyguardRectangleFramedDrawable;-><init>(Landroid/graphics/Bitmap;IIFIFI)V

    iput-object v0, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardMultiUserAvatar;->mFramed:Lcom/android/internal/policy/impl/keyguard/KeyguardRectangleFramedDrawable;

    .line 167
    iget-object v0, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardMultiUserAvatar;->mUserImage:Landroid/widget/ImageView;

    iget-object v2, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardMultiUserAvatar;->mFramed:Lcom/android/internal/policy/impl/keyguard/KeyguardRectangleFramedDrawable;
...
.method public setActive(ZZLjava/lang/Runnable;)V
    ...
    const v3, #android:string@user_switched#t
...
.method public setPressed(Z)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/internal/policy/impl/keyguard/KeyguardRectangleFramedDrawable;->setPressed(Z)V
...
.method updateVisualsForActive(ZZILjava/lang/Runnable;)V
    ...
    :goto_2
    iget-object v1, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardMultiUserAvatar;->mFramed:Lcom/android/internal/policy/impl/keyguard/KeyguardRectangleFramedDrawable;

    invoke-virtual {v1}, Lcom/android/internal/policy/impl/keyguard/KeyguardRectangleFramedDrawable;->getScale()F
    ...
    .line 201
    .local v9, initTextAlpha:I
    :goto_4
    iget v11, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardMultiUserAvatar;->mTextColor:I

    .line 202
    .local v11, textColor:I
    if-eqz p1, :cond_6

    iget v8, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardMultiUserAvatar;->mActiveStroke:F

    .line 203
    .local v8, finalStrokeWidth:F
    :goto_5
    if-eqz p1, :cond_7

    iget v7, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardMultiUserAvatar;->mInactiveStroke:F

    .line 204
    .local v7, initStrokeWidth:F
    :goto_6
    iget-object v1, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardMultiUserAvatar;->mUserName:Landroid/widget/TextView;
    ...
    invoke-direct/range {v1 .. v10}, Lcom/android/internal/policy/impl/keyguard/KeyguardMultiUserAvatar$1;-><init>(Lcom/android/internal/policy/impl/keyguard/KeyguardMultiUserAvatar;FFFFFFII)V
    ...
    .end local v7           #initStrokeWidth:F
    .end local v8           #finalStrokeWidth:F
    .end local v9           #initTextAlpha:I
    .end local v10           #finalTextAlpha:I
    ...
    .line 199
    .restart local v10       #finalTextAlpha:I
    :cond_5
    iget v1, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardMultiUserAvatar;->mActiveTextAlpha:F
    ...
    .line 202
    .restart local v9       #initTextAlpha:I
    .restart local v11       #textColor:I
    :cond_6
    iget v8, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardMultiUserAvatar;->mInactiveStroke:F

    goto :goto_5

    .line 203
    .restart local v8       #finalStrokeWidth:F
    :cond_7
    iget v7, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardMultiUserAvatar;->mActiveStroke:F

    goto :goto_6

    .line 234
    .restart local v7       #initStrokeWidth:F
    :cond_8
    iget-object v1, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardMultiUserAvatar;->mFramed:Lcom/android/internal/policy/impl/keyguard/KeyguardRectangleFramedDrawable;

    invoke-virtual {v1, v4}, Lcom/android/internal/policy/impl/keyguard/KeyguardRectangleFramedDrawable;->setScale(F)V
    ...
    invoke-static {v10, v2, v13, v14}, Landroid/graphics/Color;->argb(IIII)I
    ...
    invoke-virtual {v1, v8}, Lcom/android/internal/policy/impl/keyguard/KeyguardRectangleFramedDrawable;->setStrokeWidth(F)V

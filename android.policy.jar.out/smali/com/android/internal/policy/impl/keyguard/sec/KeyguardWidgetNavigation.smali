...
.method private getNavigationImage(Lcom/android/internal/policy/impl/keyguard/sec/KeyguardWidgetNavigation$PageType;)I
    ...
    .prologue
    const v0, #android:drawable@keyguard_navigation_normal#t
    ...
    .line 149
    :pswitch_1
    const v0, #android:drawable@keyguard_navigation_add_current#t

    goto :goto_0

    .line 151
    :pswitch_2
    const v0, #android:drawable@keyguard_navigation_add#t

    goto :goto_0

    .line 153
    :pswitch_3
    const v0, #android:drawable@keyguard_navigation_home_current#t

    goto :goto_0

    .line 155
    :pswitch_4
    const v0, #android:drawable@keyguard_navigation_home#t

    goto :goto_0

    .line 157
    :pswitch_5
    const v0, #android:drawable@keyguard_navigation_current#t
...
.method private initWidgetNavigationLayout(Ljava/util/ArrayList;)V
    ...
    const v9, #android:dimen@keyguard_navigation_padding#t
    ...
    const v8, #android:drawable@keyguard_navigation_add_current#t
    ...
    const v8, #android:drawable@keyguard_navigation_add#t
    ...
    const v8, #android:drawable@keyguard_navigation_home_current#t
    ...
    const v8, #android:drawable@keyguard_navigation_home#t
    ...
    const v8, #android:drawable@keyguard_navigation_current#t
    ...
    const v8, #android:drawable@keyguard_navigation_normal#t
